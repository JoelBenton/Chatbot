    ...
    public class Client
    {
        ...
        public async void DownloadAudio(string URL) 
        {
            ...
            else 
            {
                ...
                await youtubeClient.Videos.Streams.DownloadAsync(audioOnly, @$"C:\Users\joel2\Documents\University work\Software Engineering\Assessments\Sprint 3\Chatbot\Music\Music Files\audio.{audioOnly.Container}");
            }
        }

        public void ConvertToWAV(string path) 
        {
            var inputPath = new MediaFile { Filename = @"C:\Users\joel2\Documents\University work\Software Engineering\Assessments\Sprint 3\Chatbot\Music\Music Files\audio.mp4" };
            var outputPath = new MediaFile { Filename = $@"C:\Users\joel2\Documents\University work\Software Engineering\Assessments\Sprint 3\Chatbot\Music\Music Files\{Title}.wav" };
